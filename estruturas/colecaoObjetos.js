...
//imprimi id da disciplina resp: 5
console.log( colecao_disciplinas[4].id );
 //imprimi valor do nome da disciplina resp: Química
console.log( colecao_disciplinas[4].nome ); 
//imprimi valor da carga horaria da disciplina resp: 160
console.log( colecao_disciplinas[4].carga_horaria ); 
