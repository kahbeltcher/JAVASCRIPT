...
const filmesBuscaPorNome = filmes.filter((filme) =>
  filme.titulo.toLowerCase().includes("retorno")
);
console.log(filmesBuscaPorNome);

const filmesDoMesmoDiretor = filmes.filter(
  (filme) => filme.diretor === "Quentin Tarantino"
);
